...
class StockDataService:
    ...
    async def _load_korean_stocks(self) -> Dict[str, str]:
        ...
        try:
            ...
            return {"삼성전자": "005930", "SK하이닉스": "000660", "NAVER": "035420"}
    ...
    async def search_stocks(
        self, query: str, market: MarketType, limit: int = 20
    ) -> List[Dict]:
        """주식 검색"""
    ...
    async def _get_korean_stock_data(
        self, symbol: str, period: PeriodType
