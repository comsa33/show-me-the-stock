...
class PykrxStockDataFetcher:
    ...
    def get_market_ticker_list(self, market: str = "KOSPI", date: str = None) -> List[Dict[str, str]]:
        """
    ...
    def get_market_ohlcv_today(self, market: str = "KOSPI", limit: int = 50) -> List[Dict]:
        """
    ...
    def get_stock_ohlcv(self, symbol: str, start_date: str, end_date: str = None, market: str = "KR") -> Optional[pd.DataFrame]:
        """
        개별 종목 OHLCV 조회
        Args:
            symbol: 종목 코드
    ...
    def get_popular_stocks(self, market: str = "KR", limit: int = 10) -> List[Dict]:
        ...
        try:
            if market.upper() == "KR":
                ...
                # 거래대금 상위로 정렬
                sorted_data = sorted(all_data, key=lambda x: x['trading_value'], reverse=True)
                    ...
                    try:
                        ...
                        if not hist.empty:
                            ...
                            result.append({
                                ...
                                "trading_value": current_price * hist['Volume'].iloc[-1]
                            })
                    except Exception as e:
    ...
    def search_stocks(self, query: str, market: str = "KR", limit: int = 20) -> List[Dict]:
        """
        종목 검색
        Args:
            query: 검색어
